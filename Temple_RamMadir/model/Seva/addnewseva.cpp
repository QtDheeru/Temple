...
addnewseva::addnewseva(QWidget *parent) : QWidget(parent)
{
    ...
    vr1= new QVBoxLayout;
    image= new QPixmap(":/Images/calender_1.png");
    calendar =new QCalendarWidget;
    calendar->setWindowFlags(Qt::WindowSystemMenuHint|Qt::WindowCloseButtonHint);
    calendar->setWindowModality(Qt::ApplicationModal);
    calendar->setAttribute(Qt::WA_DeleteOnClose,false);
