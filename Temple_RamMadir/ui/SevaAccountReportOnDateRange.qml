                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        if (mouse.button === Qt.LeftButton)
                        {
                            ...
                            var obj = sevaProxy.sevaReport.accountReportDateRangeModel.getAccountReportDateRangeElementAt(lv1.currentRow);
                            console.log("/////////////////////////////"+obj.date)
                            loadSingleDatePage(obj.date);
                        }
                    }
                }
            }
...
//            }
    ...
    Keys.onEscapePressed: {
        ...
        {
              console.log("Esc pressed in  seva acc report on Date Range page loadMonthWisePage()")
            loadMonthWisePage()
        }
        else{
              console.log("Esc pressed in  seva acc report on Date Range page loadMenuPage();")
            loadMenuPage();
        }
    }
}
