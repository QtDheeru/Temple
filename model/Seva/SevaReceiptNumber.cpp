...
QString SevaReceiptNumber::getNextReceiptNumber()
{
    ...
    SmartTemple::ReceiptBookManagement::ReceiptBookManager *mgr = SmartTemple::ReceiptBookManagement::ReceiptBookManager::getInstance();
    QString recNo = mgr->getNextReceiptNumber();
    return recNo;
...
bool SevaReceiptNumber::updateReceiptNumber(QString recNo)
{
    SmartTemple::ReceiptBookManagement::ReceiptBookManager *mgr = SmartTemple::ReceiptBookManagement::ReceiptBookManager::getInstance();
    mgr->updateReceiptNumber(recNo);
    return true;
}
