...
void Tempmange::t_mange(QString username)
{
    add =new addnewseva;
    w = new seva_type;
    table_type = new TableViewType;
    table_seva = new TableViewSeva ;
    ...
    QObject::connect(w,SIGNAL(modifaid(int,int,QString,int,QString)),table_type,SLOT(modified_data(int,int,QString,int,QString)));
    ...
    QObject::connect(add,SIGNAL(sevaName(int,QString,int,QString,QString,int,QString,int)),db,SLOT(check_sevaname_allreadyexist(int,QString,int,QString,QString,int,QString,int)));
    QObject::connect(db,SIGNAL(modifying_seva(int,int,QString,int,QString,QString,int,QString,int)),table_seva,SLOT(modified_data_seva(int,int,QString,int,QString,QString,int,QString,int)));
