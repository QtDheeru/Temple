...
Rectangle{
    ...
    ReportFooter{
        ...
        width: _root.width
        height: footerHeight
        totalSevaCount : sevaProxy.sevaReport.accReportModel.sevasCount
        ...
        grandTotal: sevaProxy.sevaReport.accReportModel.grandTotal
    }
