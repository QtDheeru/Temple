...
Dialog {
   ...
   // property alias _serialNo: _allViewDataDetails._allViewSerialNo
    property alias _personId: _allViewDataDetails._allViewPersonId
    property alias _devoteeName: _allViewDataDetails._allViewDevoteeName
    property alias _mobileNo: _allViewDataDetails._allViewMobileNo
    property alias _gothra:_allViewDataDetails._allViewGothra
    property alias _nakshatra:_allViewDataDetails._allViewNakshatra
    property alias _sevaType: _allViewDataDetails._allViewSevaType
    property alias _sevaName:_allViewDataDetails._allViewSevaName
    property alias _quantity:_allViewDataDetails._allViewQuantity
    property alias _receiptDate:_allViewDataDetails._allViewReceiptDate
    property alias _sevaDate:_allViewDataDetails._allViewSevaDate
    property alias _totalCost:_allViewDataDetails._allViewTotalCost
    property alias _cash:_allViewDataDetails._allViewCash
    property alias _bank:_allViewDataDetails._allViewBank
    title: "InitiatePrintBookingReceipt"
    ...
    header: Rectangle{
        ...
        Text { text :"Print Booking Receipt";anchors.centerIn: parent;
            font.pixelSize: 20}
    }
    footer: Rectangle {
        width: parent.width
...
//            }
    ...
    contentItem: AllViewDataDetails{id:_allViewDataDetails;Layout.fillWidth: true}
