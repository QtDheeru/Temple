#############################################################################
# Makefile for building: MyTempleTrial
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  MyTempleTrial.pro
# Template: app
# Command: D:\Qt\5.15.2\mingw81_64\bin\qmake.exe -o Makefile MyTempleTrial.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
ZIP           = zip -r -9
DEF_FILE      = 
RES_FILE      = MyTempleTrial_resource_res.o
...
Makefile: MyTempleTrial.pro D:/Qt/5.15.2/mingw81_64/mkspecs/win32-g++/qmake.conf D:/Qt/5.15.2/mingw81_64/mkspecs/features/spec_pre.prf \
		...
		model/Print/Print.pri \
		model/Seva/SevaJson/SevaJson.pri \
		model/Reports/Reports.pri \
		model/Seva/seva.pri \
		model/DataSave/DataSave.pri \
		model/voucher/voucher.pri \
		model/DevoteeManager/Devotee.pri \
		...
		D:/Qt/5.15.2/mingw81_64/lib/Qt5Xml.prl \
		...
		qml.qrc
	$(QMAKE) -o Makefile MyTempleTrial.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
